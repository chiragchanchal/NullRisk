...
import { LayoutDashboard, Briefcase, TrendingUp, Star, LogOut, Settings, Trophy, BarChart2, X, AlertOctagon, RefreshCw } from 'lucide-react'
        ...
        {isSettingsOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
            <motion.div
              ...
              className="w-full max-w-md bg-zinc-950 border border-zinc-800 rounded-xl overflow-hidden shadow-2xl font-mono"
            >
              {/* Header */}
